...
},{"./components/tasks":"dqZzm"}],"dqZzm":[function(require,module,exports) {
/*//////////////////////////////////////////////////////////
...
function renderTask(task1) {
    ...
    item.innerHTML = "<p>" + task1.taskName + "</p>" + "<p>" + task1.description + "</p>" + "<span>" + task1.dueDate + "</span>" + "<span>" + task1.priority + "</span>" + "<span>" + task1.category + "</span>";
    ...
    */ // Extra Task DOM elements
    ...
    delButton.addEventListener("click", function(event) {
        ...
        item.remove();
        taskListArray = taskListArray.filter((e)=>e !== item
        ); //Remove saved task  
...
//# sourceMappingURL=task-board.3b06b0f7.js.map
